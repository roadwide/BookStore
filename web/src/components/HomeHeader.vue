<template>
    <nav>
        <ul>
            <li>
                <router-link to="/all-books">All Books</router-link>
            </li>
            <li v-show="userState.isLogin">
            ...
            <li style="float:right" v-show="!userState.isLogin">
            ...
            <li @click="logout" style="float:right;border-right: none;" v-show="userState.isLogin"><a href="#">注销</a>
            </li>
            <li style="float:right" v-show="userState.isLogin"><a>您好，{{ userState.username }}</a></li>
...
ul {
    ...
    padding: 0;
    /* overflow:hidden 被添加到 ul 元素，以防止 li 元素超出列表。  没有这一句就没有背景色，不知道为什么*/
    overflow: hidden;
    border: 1px solid #e7e7e7;
    background-color: #f3f3f3;
    /* 背景色的宽度跟屏幕一样，需要将背景色设置添加到ul元素中 */
}
...
li {
    ...
    /* display: inline;    */
    float: left;
    /* a标签 display: block;会导致导航栏变成纵向的，加上这一行恢复横向 */
