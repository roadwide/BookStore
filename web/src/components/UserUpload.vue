...
<template>
  <div style="max-width:400px;">
    <el-form ref="booInfoFormRef" :model="bookInfo" status-icon label-width="120px" class="demo-ruleForm"
      style="max-width:400px;">
      <el-form-item label="上传文件" prop="file">
        <!-- name是上传的文件字段名，也就是后端接收的form索引的key，默认是file -->
        <el-upload ref="upload" class="upload-demo" :action="api_url" :limit="1" :on-exceed="handleExceed"
          :auto-upload="false" :on-success="handleSuccess" name="file">
          <template #trigger>
      ...
      <el-form-item label="价格" prop="bookPrice">
        <el-input v-model="bookInfo.bookPrice" type="text" oninput="value=value.replace(/[^0-9.]/g,'')" />
      </el-form-item>
      <el-form-item>
